...
import be.smals.research.bulksign.desktopapp.eid.external.io.LocalAppletProtocolContext;
import be.smals.research.bulksign.desktopapp.eid.external.sc.PcscEid;
import be.smals.research.bulksign.desktopapp.eid.external.sc.Task;
import be.smals.research.bulksign.desktopapp.eid.external.sc.TaskRunner;
import be.smals.research.bulksign.desktopapp.eid.external.shared.AdministrationMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.AppletProtocolMessageCatalog;
import be.smals.research.bulksign.desktopapp.eid.external.shared.AuthSignRequestMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.AuthSignResponseMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.AuthenticationContract;
import be.smals.research.bulksign.desktopapp.eid.external.shared.AuthenticationDataMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.AuthenticationRequestMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.CheckClientMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.ClientEnvironmentMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.ContinueInsecureMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.ErrorCode;
import be.smals.research.bulksign.desktopapp.eid.external.shared.FileDigestsDataMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.FilesDigestRequestMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.FinishedMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.HelloMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.IdentificationRequestMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.IdentityDataMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.InsecureClientMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.SignCertificatesDataMessage;
import be.smals.research.bulksign.desktopapp.eid.external.shared.SignCertificatesRequestMessage;
