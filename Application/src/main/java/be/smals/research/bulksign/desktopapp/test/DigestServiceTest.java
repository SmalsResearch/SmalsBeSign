...
public class DigestServiceTest {
    ...
    @Test public void computeIndividualDigestNotNullTest () {
        try {
            FileInputStream fileInputStream = new FileInputStream(new File(getClass().getClassLoader().getResource("testFiles/file.txt").getPath()));
    ...
    @Test public void computeMasterDigestNotNullTest () {
        try {
            ...
            files[0] = new FileInputStream(new File(getClass().getClassLoader().getResource("testFiles/file.txt").getPath()));
            files[1] = new FileInputStream(new File(getClass().getClassLoader().getResource("testFiles/file.txt").getPath()));
            files[2] = new FileInputStream(new File(getClass().getClassLoader().getResource("testFiles/file.txt").getPath()));
            files[3] = new FileInputStream(new File(getClass().getClassLoader().getResource("testFiles/file.txt").getPath()));
            files[4] = new FileInputStream(new File(getClass().getClassLoader().getResource("testFiles/file.txt").getPath()));
